...
// `;
const code = `
/* path: /Volumes/code/personal/languageStudy/js/test/262/lib/es5/sta.js */
...
function GetSundayInMonth(t, m, count) {
  ...
  console.log('==== t, m, count: ', t, m, count)
...
}/* path: /Volumes/code/personal/languageStudy/js/test/262/lib/es5/framework.js */
// Copyright 2009 the Sputnik authors.  All rights reserved.
// This code is governed by the BSD license found in the LICENSE file.
